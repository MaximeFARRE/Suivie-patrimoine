...
from services.prevision_models import PrevisionBase, PrevisionConfig
from services.prevision_stress import get_double_shock, get_equity_crash_20, get_income_shock_12m
from services.prevision_stress_models import AssetStress, StressScenario
...
def make_dummy_config():
    return PrevisionConfig(horizon_years=5, monthly_contribution=1000.0, inflation_rate=0.02)
