...
def list_accounts_by_types(conn, person_id: int, account_types: list[str]) -> list[dict]:
    """
    ...
    """
    df = repo.list_accounts(conn, person_id=person_id)
    if df is None or df.empty:
        return []
