from .prevision_stress_models import AssetStress, IncomeStress, StressScenario
...
def get_equity_crash_20() -> StressScenario:
    ...
    return StressScenario(
        ...
        assets_stress={"Bourse": AssetStress(immediate_drop_pct=0.20, progressive_drop_pct=0.0, recovery_months=24)},
...
def get_equity_crash_30() -> StressScenario:
    ...
    return StressScenario(
        ...
        assets_stress={"Bourse": AssetStress(immediate_drop_pct=0.30, progressive_drop_pct=0.0, recovery_months=36)},
        stress_duration_months=12,
    )
