...
class AssetStress:
    ...
    recovery_months: int = (
        0  # Temps avant un retour pur et simple à la normale des rendements (si 0 = pas de rebond technique forcé)
    )
...
class StressScenario:
    ...
    stress_duration_months: int = (
        12  # Durée du scénario de crise avant retour à la "normale" des marchés, influe progressive_drop
    )
